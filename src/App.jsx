...
const tld = '.asuka';
const CONTRACT_ADDRESS = '0xDc58777D2e07658Bd6E71741F91138fE2EE6718b';
  ...
  const updateDomain = async () => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media.giphy.com/media/EdknuaSGx7H0Y/giphy.gif" alt="Asuka gif" />
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">️‍🔥 Asuka Name Service</p>
							<p className="subtitle">Your tsundere API on the blockchain!</p>
						</div>
